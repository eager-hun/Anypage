<div class="page__level">
  <div class="page__level__content">

    <h2>grid&#8209;column()</h2>

    <p>3 columns.</p>

    <div class="row" id="grid-test--3-cols-simple">
      <div class="column">
...
<div class="page__level">
  <div class="page__level__content">
    ...
    <div class="row" id="grid-test--4-cols-conditional">
      <div class="column">
        <div class="box">Item 1</div>
      </div>
      <div class="column">
...
<div class="page__level">
  <div class="page__level__content">
    ...
    <div class="row" id="grid-test--layout-mixin">
      <div class="column">
        <div class="box">Item 1</div>
      </div>
      <div class="column">
...
<div class="page__level">
  <div class="page__level__content">
    ...
    <div class="row" id="grid-test--column-position">
...
<div class="page__level">
  <div class="page__level__content">
    ...
    <div class="row" id="grid-test--nested-grids">
    ...
    <div class="row" id="grid-test--nested-grids-reference">
      <div class="column">
